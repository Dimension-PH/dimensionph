            ...
            <section className="px-10">
                ...
                <div>
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>With or without teaching experience</li>
                ...
                <div className="mt-10 p-6 rounded-lg border border-gray-200 bg-white shadow-lg">
                    <h3 className="text-xl lg:text-2xl font-medium text-gray-900 mb-3">Application Process</h3>
                    <div className="mx-auto p-6 space-y-6">
                        <section className="text-gray-800">
                            <h4 className="text-lg lg:text-xl font-semibold text-indigo-600">Application &amp; Screening</h4>
                        ...
                        <section className="text-gray-800">
                            <h4 className="text-lg lg:text-xl font-semibold text-indigo-600">Virtual Interview</h4>
                            <p className="text-base">
                        ...
                        <section className="text-gray-800">
                            <h4 className="text-lg lg:text-xl font-semibold text-indigo-600">Pre-Service Orientation (PSO)</h4>
                            <p className="text-base">
                        ...
                        <section className="text-gray-800">
                            <h4 className="text-lg lg:text-xl font-semibold text-indigo-600">New Teacher Training (NTT)</h4>
                            <p className="text-base">
                        ...
                        <section className="text-gray-800">
                            <h4 className="text-lg lg:text-xl font-semibold text-indigo-600">Mock Demo Lesson</h4>
                            <p className="text-base">
                        ...
                        <section className="text-gray-800">
                            <h4 className="text-lg lg:text-xl font-semibold text-indigo-600">Final Demo Lesson</h4>
                            <p className="text-base">
                        ...
                        <section className="text-gray-800">
                            <h4 className="text-lg lg:text-xl font-semibold text-indigo-600">Onboarding &amp; Go-Live</h4>
                            <p className="text-base">
